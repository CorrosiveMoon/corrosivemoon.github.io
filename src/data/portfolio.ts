...
export const portfolioData: PortfolioData = {
  personal: {
    ...
    description: "I train models, break stuff, then train them better. Fueled by coffee, curiosity, and occasional StackOverflow breakdowns. Hoping to solve real-world problems with intelligent, scalable systems and maybe inspire a few people along the way. Let's make machines smarter—before they make fun of us!",
